...
RSpec.describe "Spices", type: :request do
  describe "GET /spices" do
    it "returns an array of all spices" do
      Spice.create(title: "Allspice", image: "allspice.jpg")
      Spice.create(title: "Caraway Seeds", image: "caraway.jpg", description: "Caraway description", notes: "Caraway notes", rating: 2)
